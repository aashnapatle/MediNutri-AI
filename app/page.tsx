              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground mt-2">
                    {result?.category === "Normal" || !result
                      ? "Great! You have a normal body weight."
                      : `Your BMI indicates ${result.category.toLowerCase()} weight.`}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-2">
                    {result?.suggestion || "You are in good shape! Maintain a balanced diet and exercise regularly to stay healthy."}
                  </p>
                </div>
              </div>
            </CardContent>
